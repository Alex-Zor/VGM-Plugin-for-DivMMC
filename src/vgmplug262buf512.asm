                        output_bin "d:\VGM", $8000, endvgm - $8000;
...
pos0:                   ld b,8                          ; 8 lines
lp_pos0:                ld a, (de)                      ; read from vram
...
pos1:                   ld b,8                          ; 8 lines
lp_pos1:                ld a, (de)                      ; read from vram
...
pos2:                   ld b,8                          ; 8 lines
lp_pos2:                ld a, (hl)                      ; read byte from table
                        rlc a                           ;
                        rlc a                           ;
                        and $03                         ;
                        ld c, a                         ;
...
pos3:                   ld b,8                          ; 8 lines
lp_pos3:                ld a, (hl)                      ; read byte from table
                        srl a                           ;
                        srl a                           ;
                        srl a                           ;
                        srl a                           ;
...
txt_title:              db $80, $84, $84, $84, $84, $84, $84, $84, $84, $84, $84, $84, $84, " VGM Player 0.5 " , $84, $84, $84, $84, $84, $84, $84, $84,$84, $84, $84, $84, $81, 0;
